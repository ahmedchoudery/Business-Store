...
const connectDB = require('../backend-logic/config/db');
 ...
 * 
 * Vercel uses this file as a serverless function entry point.
 * All business logic is imported from the /backend-logic folder.
 */
...
// ─── Main API Routes ──────────────────────────────────────────────────────────
const contactRouter = require('../backend-logic/routes/contact');
const personalizeRouter = require('../backend-logic/routes/personalize');
const mainRouter = express.Router();
mainRouter.use('/contact', contactRouter);
mainRouter.use('/personalize', personalizeRouter);
