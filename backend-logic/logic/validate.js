...
const contactValidationRules = [
    ...
    body('roleTarget')
        .optional()
        .trim()
        .isLength({ max: 50 }).withMessage('Role target is too long'),
    ...
    body('jobTitle')
        .optional()
        .trim()
        .isLength({ max: 120 }).withMessage('Job title cannot exceed 120 characters'),

    body('recruiterName')
        .optional()
        .trim()
        .isLength({ max: 100 }).withMessage('Recruiter name cannot exceed 100 characters'),
];
